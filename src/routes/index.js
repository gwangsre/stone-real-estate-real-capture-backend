...
import formHeaderRouter from "./form-header.routes.js";
import footerRouter from "./footer.routes.js";
...
// Form Header and Footer: GET public, PATCH protected
r.use("/form-header", formHeaderRouter);
r.use("/footer", footerRouter);
